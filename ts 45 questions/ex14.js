"use strict";
//Guest list: invite anyone,living or deceased,to dinner,who would invite?
...
guestlist.forEach((guestName) => console.log("Dear${Zia khan},you are invited to dinner.please join us."));
